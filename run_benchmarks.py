#!/usr/bin/env python3
"""
Run all RCMADP Interleaved benchmarks and generate HTML reports.

Usage:
    python run_benchmarks.py
    python run_benchmarks.py --pop 6000 --gen 30000
    python run_benchmarks.py --output results_folder
"""
...
# Configuration
SOLVER_PATH = "brkga/rcmadp_interleaved_solver"
...
def write_summary(output_dir, results, args):
    ...
    with open(summary_md, "w") as f:
        f.write(f"# RCMADP Interleaved Benchmark Results\n\n")
...
def main():
    parser = argparse.ArgumentParser(description="Run RCMADP Interleaved benchmarks")
    ...
    if not os.path.exists(SOLVER_PATH):
        ...
        print("      examples/rcmadp_interleaved_example.cu -o rcmadp_interleaved_solver \\")
        print("      -lcurand -lcudart")
        sys.exit(1)
